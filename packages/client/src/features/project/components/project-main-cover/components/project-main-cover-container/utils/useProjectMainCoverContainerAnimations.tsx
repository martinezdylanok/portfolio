...
export interface UseProjectMainCoverContainerAnimationsReturn {
...
export const useProjectMainCoverContainerAnimations = (): UseProjectMainCoverContainerAnimationsReturn => {
