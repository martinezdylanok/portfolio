...
export interface UseAboutMeDetailedPhilosophyAnimationsReturn {
...
export const useAboutMeDetailedPhilosophyAnimations = (): UseAboutMeDetailedPhilosophyAnimationsReturn => {
