...
export interface UseAboutMeDetailedToolCategoryAnimationsReturn {
...
export const useAboutMeDetailedToolCategoryAnimations = (): UseAboutMeDetailedToolCategoryAnimationsReturn => {
