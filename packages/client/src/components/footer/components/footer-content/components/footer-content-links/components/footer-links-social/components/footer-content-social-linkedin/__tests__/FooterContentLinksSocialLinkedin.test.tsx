...
describe("FooterContentLinksSocialLinkedin component tests", () => {
   ...
   test("renders the FooterContentLinksLinkeding div element", () => {
   ...
   test("renders the FooterContentLinksLinkeding a element", () => {
      render(<FooterContentLinksSocialLinkedin />);
   ...
   test("renders the FooterContentLinksLinkeding element", () => {
      render(<FooterContentLinksSocialLinkedin />);
   ...
   test("renders the FooterContentLinksLinkeding light mode element", () => {
      render(<FooterContentLinksSocialLinkedin />);
   ...
   test("renders the FooterContentLinksLinkeding dark mode element", () => {
      setupDarkMode();
      render(<FooterContentLinksSocialLinkedin />);
